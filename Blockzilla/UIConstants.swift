...
struct UIConstants {
    ...
    struct strings {
        ...
        static let urlPaste = NSLocalizedString("URL.paste", value: "Paste", comment: "Text for the URL context menu when a user long presses on the URL bar with clipboard contents.")
