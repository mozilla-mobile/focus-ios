...
struct UIConstants {
    ...
    struct strings {
        ...
        static let renameShortcut = NSLocalizedString("ShortcutView.Rename", value: "Rename", comment: "Text for the long press on a shortcut rename option in context menu.")
        ...
        static let renameShortcutAlertPrimaryAction = NSLocalizedString("ShortcutView.RenameShortcutAlertPrimaryAction", value: "Rename", comment: "Text for the rename shortcut alert primary action.")
