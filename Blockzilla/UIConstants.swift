...
struct UIConstants {
    ...
    struct strings {
        ...
        static let toggleSectionAssistance = NSLocalizedString("Settings.sectionAssistance", value: "ASSISTANCE", comment: "Section label for Assistance settings")
        static let settingsCustomDomain = NSLocalizedString("Settings.customDomain", value: "CUSTOM DOMAIN", comment: "Custom Domain setting label")
        static let settingsAutocomplete = NSLocalizedString("Settings.autocomplete", value: "Autocomplete", comment: "Autocomplete setting label")
        static let settingsAddDomain = NSLocalizedString("Settings.addDomain", value: "Add Domain", comment: "Add domain setting label")
        static let settingsEnableAutocomplete = NSLocalizedString("Settings.enableAutocomplete", value: "Enable Domain Autocomplete", comment: "Enable autocomplete settings label")
