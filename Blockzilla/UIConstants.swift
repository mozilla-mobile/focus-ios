...
struct UIConstants {
    ...
    struct strings {
        ...
        static let labelBlockAds2 = NSLocalizedString("Settings.toggleBlockAds2", value: "Advertising", comment: "Label for toggle on main screen")
        ...
        static let labelBlockAnalytics = NSLocalizedString("Settings.toggleBlockAnalytics2", value: "Analytics", comment: "Label for toggle on main screen")
        static let labelBlockSocial = NSLocalizedString("Settings.toggleBlockSocial2", value: "Social", comment: "Label for toggle on main screen")
        static let labelBlockOther = NSLocalizedString("Settings.toggleBlockOther2", value: "Content", comment: "Label for toggle on main screen")
