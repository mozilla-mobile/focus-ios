...
struct UIConstants {
    ...
    struct strings {
        ...
        static let labelBlockFonts = NSLocalizedString("Settings.toggleBlockWebFonts", value: "Block Web Fonts", comment: "Label for toggle on main screen")
        static let labelSendAnonymousUsageData = NSLocalizedString("Settings.toggleSendData", value: "Send Usage Data", comment: "Label for Send Usage Data toggle on main screen")
