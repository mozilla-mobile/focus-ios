...
class OverlayView: UIView {
    ...
    init() {
        ...
        searchButton.backgroundColor = UIConstants.colors.backgroundColor
        ...
        findInPageButton.backgroundColor = UIConstants.colors.backgroundColor
        ...
        copyButton.backgroundColor = UIConstants.colors.backgroundColor
