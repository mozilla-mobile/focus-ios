...
class AddSearchEngineViewController: UIViewController, UITextViewDelegate {
    ...
    private func setupUI() {
        ...
        nameInput.attributedPlaceholder = NSAttributedString(string: UIConstants.strings.AddSearchEngineName, attributes: [NSAttributedString.Key.foregroundColor: UIConstants.colors.settingsDetailLabel])
        ...
        let subtitle = NSMutableAttributedString(string: UIConstants.strings.AddSearchEngineTemplateExample, attributes: [NSAttributedString.Key.foregroundColor : UIConstants.colors.settingsDetailLabel])
