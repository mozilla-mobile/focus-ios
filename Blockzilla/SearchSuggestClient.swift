...
class SearchSuggestClient {
    ...
    init(){
        ...
        self.searchEngine = OpenSearchEngine(engineID: engineName,shortName: engineName, image: UIImage(),
                                             searchTemplate: "", suggestTemplate: "https://www.google.com/complete/search?client=firefox&q={searchTerms}", isCustomEngine: SearchEngineManager(prefs: UserDefaults.standard).activeEngine.isCustom)
    }
