...
class SettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    private var initialToggles : [Int : BlockerToggle]  {
        ...
        let usageDataToggle = BlockerToggle(label: UIConstants.strings.labelSendAnonymousUsageData, setting: SettingsToggle.sendAnonymousUsageData, subtitle: String(format: UIConstants.strings.detailTextSendUsageData, AppInfo.productName))
