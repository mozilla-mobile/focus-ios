...
@objc public protocol AutocompleteTextFieldDelegateOld: AnyObject {
    func autocompleteTextFieldShouldBeginEditing(_ autocompleteTextField: AutocompleteTextFieldOld) -> Bool
    func autocompleteTextFieldShouldEndEditing(_ autocompleteTextField: AutocompleteTextFieldOld) -> Bool
    func autocompleteTextFieldShouldReturn(_ autocompleteTextField: AutocompleteTextFieldOld) -> Bool
    func autocompleteTextField(_ autocompleteTextField: AutocompleteTextFieldOld, didTextChange text: String)
}

open class AutocompleteTextFieldOld: UITextField, UITextFieldDelegate {
    ...
    public weak var autocompleteDelegate: AutocompleteTextFieldDelegateOld?
...
//        if let completionRange = completionRange, string.isEmpty, NSIntersectionRange(range, completionRange).length > 0 {
//            self.deleteBackward()
//            return false
//        }
//        return true
        if lastReplacement == nil {
            autocompleteDelegate?.autocompleteTextField(self, didTextChange: "")
        }
