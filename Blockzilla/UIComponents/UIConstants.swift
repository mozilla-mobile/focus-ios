...
struct UIConstants {
    ...
    struct strings {
        ...
        static let defaultBrowserOnboardingViewTitleV2 = NSLocalizedString("Onboarding.SecondScreen.Title.V2", value: "Focus isn't like other browsers", comment: "Text for a label that indicates the title for the second onboarding screen version 2.")
        static let defaultBrowserOnboardingViewFirstSubtitleV2 = NSLocalizedString("Onboarding.SecondScreen.FirstSubtitle.V2", value: "We clear your history when you close the app for extra privacy.", comment: "Text for a label that indicates the first subtitle for the second onboarding screen version 2.")
        static let defaultBrowserOnboardingViewSecondSubtitleV2 = NSLocalizedString("Onboarding.SecondScreen.SecondSubtitle.V2", value: "Make Focus your default to protect your data with every link you open.", comment: "Text for a label that indicates the second subtitle for the second onboarding screen version 2.")
        static let defaultBrowserOnboardingViewTopButtonTitleV2 = NSLocalizedString("Onboarding.SecondScreen.TopButtonTitle.V2", value: "Set as Default Browser", comment: "Text for a label that indicates the title of the top button from the second onboarding screen version 2.")
        static let defaultBrowserOnboardingViewBottomButtonTitleV2 = NSLocalizedString("Onboarding.SecondScreen.BottomButtonTitle.V2", value: "Skip", comment: "Text for a label that indicates the title of the bottom button from the second onboarding screen version 2.")
