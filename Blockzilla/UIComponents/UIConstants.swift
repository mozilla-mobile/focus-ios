...
struct UIConstants {
    ...
    struct strings {
        ...
        static let titleShowMeHowOnboardingV2 = NSLocalizedString("ShowMeHowOnboarding.Title.V2", value: "Add a Focus Widget", comment: "This is the title text that is displayed in the Show Me How Onboarding Screen")
